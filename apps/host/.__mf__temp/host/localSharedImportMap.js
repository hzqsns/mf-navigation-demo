...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "@ant-design/pro-components": async () => {
          let pkg = await import("__mf__virtual/host__prebuild___mf_0_ant_mf_2_design_mf_1_pro_mf_2_components__prebuild__.js")
          return pkg
        }
      ,
        "antd": async () => {
          let pkg = await import("__mf__virtual/host__prebuild__antd__prebuild__.js")
          return pkg
        }
      ,
        "react": async () => {
